...
import com.ctl.it.qa.passweb.tools.pages.SalesDraftToSalesFinal.LiteQuoteEditPage;
import com.ctl.it.qa.passweb.tools.pages.SalesDraftToSalesFinal.ManageOrdersPage;
import com.ctl.it.qa.passweb.tools.pages.SalesDraftToSalesFinal.ManageProductsPage;
...
public class OptySteps extends SfaSteps {
	...
	public void add_contact_role_for_opty() {
		...
		contactRolesForOptyPage.fillMandatoryFields(contactRolesForOptyPage);
	...
	public void adds_lq_lite_quote_to_opty(String productName, String region) {
		...
		liteQuoteEditPage.fillMandatoryFields(liteQuoteEditPage);
		waitABit(2000);
		liteQuoteEditPage.fillAllFields(liteQuoteEditPage);
	...
	public void add_product_to_opty(String productName) {
		...
		addProductsForOptyPage.fillMandatoryFields(addProductsForOptyPage);
